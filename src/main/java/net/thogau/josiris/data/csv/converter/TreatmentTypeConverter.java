...
@Component
public class TreatmentTypeConverter<T, I> extends AbstractBeanField<T, I> {
	...
	protected Object convert(String value) throws CsvDataTypeMismatchException, CsvConstraintViolationException {
		Object o = service.getValue(TreatmentType.class, value);
		return o != null ? o : service.getValue(TreatmentType.class, "UMLS:C0439673");
	}
