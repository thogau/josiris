...
public class TumorPathologyEventMappingStrategy extends HeaderColumnNameMappingStrategy<TumorPathologyEvent> {

	private final AutowireCapableBeanFactory beanFactory;

	public TumorPathologyEventMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<TumorPathologyEvent, String>> converter = (Class<? extends AbstractBeanField<TumorPathologyEvent, String>>) annotation
				.converter();
		BeanField<TumorPathologyEvent, String> bean = instantiateCustomConverter(converter);
