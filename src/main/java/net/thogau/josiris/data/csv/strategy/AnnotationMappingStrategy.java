...
public class AnnotationMappingStrategy extends HeaderColumnNameMappingStrategy<Annotation> {

	private final AutowireCapableBeanFactory beanFactory;

	public AnnotationMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Annotation, String>> converter = (Class<? extends AbstractBeanField<Annotation, String>>) annotation
				.converter();
		BeanField<Annotation, String> bean = instantiateCustomConverter(converter);
