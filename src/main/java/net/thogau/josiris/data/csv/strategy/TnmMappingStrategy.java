...
public class TnmMappingStrategy extends HeaderColumnNameMappingStrategy<Tnm> {

	private final AutowireCapableBeanFactory beanFactory;

	public TnmMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Tnm, String>> converter = (Class<? extends AbstractBeanField<Tnm, String>>) annotation
				.converter();
		BeanField<Tnm, String> bean = instantiateCustomConverter(converter);
