...
public class AnalysisMappingStrategy extends HeaderColumnNameMappingStrategy<Analysis> {

	private final AutowireCapableBeanFactory beanFactory;

	public AnalysisMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Analysis, String>> converter = (Class<? extends AbstractBeanField<Analysis, String>>) annotation
				.converter();
		BeanField<Analysis, String> bean = instantiateCustomConverter(converter);
