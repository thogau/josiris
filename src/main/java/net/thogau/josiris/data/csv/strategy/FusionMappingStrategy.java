...
public class FusionMappingStrategy extends HeaderColumnNameMappingStrategy<Fusion> {

	private final AutowireCapableBeanFactory beanFactory;

	public FusionMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Fusion, String>> converter = (Class<? extends AbstractBeanField<Fusion, String>>) annotation
				.converter();
		BeanField<Fusion, String> bean = instantiateCustomConverter(converter);
