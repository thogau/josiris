...
public class DrugMappingStrategy extends HeaderColumnNameMappingStrategy<CsvDrug> {

	private final AutowireCapableBeanFactory beanFactory;

	public DrugMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<CsvDrug, String>> converter = (Class<? extends AbstractBeanField<CsvDrug, String>>) annotation
				.converter();
		BeanField<CsvDrug, String> bean = instantiateCustomConverter(converter);
