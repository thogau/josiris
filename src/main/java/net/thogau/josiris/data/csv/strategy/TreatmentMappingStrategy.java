...
public class TreatmentMappingStrategy extends HeaderColumnNameMappingStrategy<Treatment> {

	private final AutowireCapableBeanFactory beanFactory;

	public TreatmentMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Treatment, String>> converter = (Class<? extends AbstractBeanField<Treatment, String>>) annotation
				.converter();
		BeanField<Treatment, String> bean = instantiateCustomConverter(converter);
