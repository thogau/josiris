...
public class PatientMappingStrategy extends HeaderColumnNameMappingStrategy<Patient> {

	private final AutowireCapableBeanFactory beanFactory;

	public PatientMappingStrategy(AutowireCapableBeanFactory beanFactory) {
	...
	private void registerCustomBinding(CsvCustomBindByName annotation, Class<?> localType, Field localField) {
		...
		Class<? extends AbstractBeanField<Patient, String>> converter = (Class<? extends AbstractBeanField<Patient, String>>) annotation
				.converter();
		BeanField<Patient, String> bean = instantiateCustomConverter(converter);
